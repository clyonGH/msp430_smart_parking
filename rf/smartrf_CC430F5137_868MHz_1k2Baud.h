...
#define SMARTRF_SETTING_IOCFG2     0x29 // signal selection. Default RF_RDYn
#define SMARTRF_SETTING_IOCFG1     0x2E // signal selection. Default 3-state
#define SMARTRF_SETTING_IOCFG0     0x06
#define SMARTRF_SETTING_FIFOTHR    0x47
#define SMARTRF_SETTING_SYNC1      0xD3
#define SMARTRF_SETTING_SYNC0      0x91
#define SMARTRF_SETTING_PKTLEN     0x40  // Changed to 0x0A. Def = 0xFF
#define SMARTRF_SETTING_PKTCTRL1   0x04
#define SMARTRF_SETTING_PKTCTRL0   0x05 // CRC enable, variable packet length
...
#define SMARTRF_SETTING_MDMCFG2    0x13 // 2-GFSK, sync word 30/32
#define SMARTRF_SETTING_MDMCFG1    0x22 // 4 bytes preambles
#define SMARTRF_SETTING_MDMCFG0    0xF8 
#define SMARTRF_SETTING_DEVIATN    0x15
#define SMARTRF_SETTING_MCSM2      0x07 // timeout disable
